...
export default (prop: { gdkmonitor: Gdk.Monitor }) => {
  ...
  const workspaceIndicatorClass = (
    ...
    else return "bar__workspaces-indicator";
  };

  const workspaceOnCurrentMonitor = (workspaceId: number) =>
    hypr.get_workspace(workspaceId)?.get_monitor().get_model() ===
    prop.gdkmonitor.get_model();
            ...
            return (
              <button
                ...
                className={bind(hypr, "focusedWorkspace").as((fw) =>
                  workspaceIndicatorClass(i, fw.id),
                )}
